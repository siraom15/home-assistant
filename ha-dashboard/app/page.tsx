          ...
          <main className="min-w-0 flex-1">
            ...
            >
                  ...
                  >
                    <div>
                      ...
                      <p className="mt-3 max-w-xl text-zinc-500">
                        Monitor and control your Home Assistant
              ...
              <section className="mt-10">
                ...
                >
                  {rooms.map((room) => {
                    const roomLights = getRoomEntities(
                      lights,
                      room,
                    );

                    const roomSensors = getRoomEntities(
                      sensors,
                      room,
                    );
